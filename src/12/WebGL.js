...
export default class WebGl extends AbstractWebGL {
  ...
  initObjects() {
    ...
    const heightMap = loader.load('static/img/heightMap.png', (texture) => {
      console.log(texture.image.width);
      this.sphere.createCanvas(texture.image);
    ...
    const sprite = loader.load('static/img/sprite.png',() => {
        this.sprite = new Sprite({texture:sprite})
